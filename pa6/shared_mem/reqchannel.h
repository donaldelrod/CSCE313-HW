...
private:
	...
	KSemaphore server_read;
	KSemaphore server_read2;
	KSemaphore client_read;

	//ReqBoundedBuffer SB, CB;
...
public:
	...
	RequestChannel(const std::string _name, const Side _side, int seed);
